...
const reviewButtonBase = 'group/review relative flex h-14 items-center justify-center gap-3 overflow-hidden rounded-[14px] border px-4 text-sm font-black shadow-[0_14px_34px_rgba(0,0,0,0.22)] outline-none transition-all duration-200 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0d131c] active:scale-[0.99] sm:text-base';
...
export const InventoryFilters: React.FC<InventoryFiltersProps> = ({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid gap-3 rounded-2xl border border-white/10 bg-[#0b0d14] p-2 sm:grid-cols-[minmax(0,1fr)_auto]">
        <div className="flex min-h-14 items-center gap-3 px-2 text-gray-300">
