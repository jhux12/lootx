  ...
  return (
    <section className="mx-auto w-full max-w-6xl flex-1 space-y-5 pb-3">
      ...
      <div className="flex flex-col gap-3 rounded-3xl border border-white/10 bg-[#111824] p-5 shadow-[0_18px_45px_rgba(0,0,0,0.22)] sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" onClick={() => setView({ type: 'FAQ' })} className="inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-3 text-lg font-black text-purple-300 hover:bg-purple-500/10">Learn More <span aria-hidden="true">›</span></button>
      </div>
