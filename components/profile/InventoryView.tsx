...
export const InventoryView: React.FC<InventoryViewProps> = ({
  ...
  return (
    <section className={`w-full space-y-4 bg-[#08080a] px-5 sm:px-7 ${selectedIds.length > 0 ? 'pt-16 pb-5 md:pt-0' : 'pb-5'}`}>
      ...
      {selectedIds.length > 0 && (
        <div className="fixed inset-x-3 top-[calc(var(--pullz-header-height,70px)+8px)] z-50 mx-auto flex max-w-[30rem] flex-wrap items-center justify-between gap-3 rounded-2xl border border-purple-400/30 bg-[#111824]/95 p-3 shadow-[0_18px_45px_rgba(0,0,0,0.55)] backdrop-blur md:sticky md:inset-auto md:bottom-4 md:top-auto md:z-30 md:max-w-none">
