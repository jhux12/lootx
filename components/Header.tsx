  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 w-full flex items-center justify-between px-4 md:px-6 py-3 min-h-[72px] md:min-h-[80px] lg:min-h-[88px] bg-[#080b14]/95 border-b border-gray-800/50 backdrop-blur">
        ...
        {/* Mobile Menu Overlay */}
        {isMobileMenuOpen && (
          <div className="fixed inset-0 top-[72px] md:top-[80px] z-40 lg:hidden bg-[#0b0e14]">
            <nav className="flex min-h-full flex-col gap-2 p-4 animate-in slide-in-from-left-full duration-200">
              <button 
