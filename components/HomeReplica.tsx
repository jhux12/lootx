    ...
    <div className={`mx-auto flex w-full flex-col gap-10 px-3 pb-14 pt-6 sm:px-5 lg:px-7 ${isChatCollapsed ? 'max-w-[1240px]' : 'max-w-[1160px]'}`}>
      ...
      <section className="relative left-1/2 right-1/2 w-screen -translate-x-1/2 overflow-hidden border-y border-white/10 bg-[#11151f] shadow-[0_35px_70px_-50px_rgba(0,0,0,1)]">
        ...
        <div className="relative mx-auto flex w-full max-w-[1240px] items-end justify-center px-4 pt-10 text-center sm:px-6 sm:pt-12 lg:px-8">
          <div className="relative z-10 flex w-full flex-col items-center pb-[230px] pr-[112px] sm:pb-[280px] sm:pr-[160px] lg:min-h-[380px] lg:items-start lg:justify-center lg:pb-10 lg:pr-[20rem] lg:text-left">
            ...
            <h1 className="relative max-w-4xl text-4xl font-black uppercase italic leading-[0.9] tracking-tight text-white sm:text-6xl lg:text-7xl">
          ...
          <img
            ...
            loading="lazy"
            decoding="async"
            className="pointer-events-none absolute bottom-0 right-3 z-0 h-auto w-[120px] object-contain sm:right-5 sm:w-[160px] lg:right-8 lg:w-[240px] xl:right-12 xl:w-[280px]"
          />
        </div>
      </section>
