...
const ZYGARDE_PROMO_IMAGES = [
  'https://firebasestorage.googleapis.com/v0/b/hyperdrop-6476c.firebasestorage.app/o/boxes%2Fperfectordersealed%2F243.webp?alt=media&token=626e9c16-a815-43ef-94d5-5a7c95100930',
  'https://firebasestorage.googleapis.com/v0/b/hyperdrop-6476c.firebasestorage.app/o/boxes%2Fperfectordersealed%2FMega%20Zygarde%20ex%20-%20120088%20-%20ME03%20Perfect%20Order%20(POR).webp?alt=media&token=2166065f-56fd-4738-b65d-ac54deacbc61'
] as const;
...
const PromoBoxHeroSlide: React.FC<{ box: MysteryBox }> = ({ box }) => (
  <div className="lootx-hero-slide lootx-hero-slide--dark relative h-full w-full shrink-0 overflow-hidden px-5 py-4 sm:px-8 sm:py-6 lg:px-12 lg:py-8">
    ...
    <div className="relative z-10 flex h-full items-center justify-center text-center">
      <img src={ZYGARDE_PROMO_IMAGES[0]} alt="Perfect Order booster box" width={500} height={500} fetchPriority="high" decoding="async" className="pointer-events-none absolute left-0 top-1/2 h-24 w-24 -translate-y-1/2 object-contain drop-shadow-[0_0_18px_rgba(255,176,20,.48)] drop-shadow-[0_18px_25px_rgba(0,0,0,.62)] sm:-left-1 sm:h-32 sm:w-32 lg:left-3 lg:h-40 lg:w-40" />
      <div className="relative z-10 flex min-w-0 max-w-[180px] flex-col items-center sm:max-w-[420px] lg:max-w-[590px]">
        <h1 className="text-[20px] font-black uppercase leading-[.9] tracking-[-.04em] text-[#fff8dc] drop-shadow-[0_3px_0_rgba(0,0,0,.78)] sm:text-[30px] lg:text-[48px]">Zygarde’s <span className="text-[#ffc229]">Singles Vault</span></h1>
        <p className="mt-1.5 text-[9px] font-bold uppercase leading-tight tracking-[.12em] text-[#eaffb2] sm:text-[11px] lg:text-sm">Perfect Order awaits</p>
        <span className="mt-2 inline-flex rounded-xl border border-[#ffd45a]/70 bg-[linear-gradient(135deg,#ffd849,#a96b05)] px-3 py-2 text-[10px] font-black uppercase tracking-wide text-[#171205] shadow-[0_8px_20px_rgba(0,0,0,.48)] sm:px-4 sm:text-xs">Open now</span>
      </div>
      <img src={ZYGARDE_PROMO_IMAGES[1]} alt="Mega Zygarde ex single" width={500} height={500} fetchPriority="high" decoding="async" className="pointer-events-none absolute right-0 top-1/2 h-24 w-24 -translate-y-1/2 object-contain drop-shadow-[0_0_18px_rgba(194,255,51,.34)] drop-shadow-[0_18px_25px_rgba(0,0,0,.62)] sm:-right-1 sm:h-32 sm:w-32 lg:right-3 lg:h-40 lg:w-40" />
    </div>
  </div>
);
