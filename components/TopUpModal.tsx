                          ...
                          activePackages.map((pack) => {
                            ...
                            return (
                              <button
                                  ...
                                  className={`relative overflow-hidden rounded-lg border p-2 text-left transition-colors duration-200
                              ...
                              >
                                  ...
                                  <div className="relative z-10 flex flex-col gap-0.5">
                                    {bonusCoins > 0 && bonusLabel && (
                                      <span className="text-center text-xs font-black tracking-wide text-[#7a4bff] sm:text-sm">
                                        {bonusLabel}
                                      </span>
                                    )}
                                    <div className={`rounded-md px-2 py-1 text-center text-base font-black leading-none sm:text-lg ${isSelected ? 'bg-gradient-to-r from-[#4f63ff] via-[#6f4dff] to-[#d64dd8] text-white' : 'border border-[#2f356a] bg-[#0a0d2f] text-[#eceffd]'}`}>
                                      {pack.displayPrice}
                                    </div>
                                  </div>
                              </button>
