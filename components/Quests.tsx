  ...
  return (
    ...
    >
      ...
      <div className="mb-5 rounded-2xl border border-white/10 bg-[#161b1f] p-4 sm:p-6">
        ...
        <div className="mt-3 inline-flex items-center gap-2 rounded-xl border border-purple-500/25 bg-purple-500/10 px-3 py-1.5 text-xs font-semibold text-purple-200 sm:text-sm">
