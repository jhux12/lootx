...
export const Profile: React.FC<ProfileProps> = ({ initialTab }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Profile Header */}
      <div className="relative mb-4 overflow-hidden rounded-[28px] border border-white/8 bg-[linear-gradient(160deg,rgba(19,23,32,0.88),rgba(11,14,20,0.8))] shadow-[0_26px_64px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-xl">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.06),transparent_32%),radial-gradient(circle_at_top_left,rgba(124,58,237,0.08),transparent_38%),radial-gradient(circle_at_bottom_right,rgba(56,189,248,0.06),transparent_32%)]" />
        ...
        <div className="relative px-4 pb-3.5 pt-3.5 sm:px-5 sm:pb-4 sm:pt-4">
          <div className="flex flex-col gap-3">
            <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.09),0_18px_36px_rgba(5,10,20,0.22)] backdrop-blur-xl sm:p-4">
              <div className="flex flex-col gap-3">
                <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:items-start sm:text-left">
                  <div className="relative shrink-0">
                    ...
                    <div className="relative rounded-[24px] border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.04))] p-1 shadow-[0_16px_34px_rgba(12,17,29,0.34),inset_0_1px_0_rgba(255,255,255,0.08)]">
                      <img loading="lazy" decoding="async" src={displayUser.avatar} alt={displayUser.name} className="h-24 w-24 rounded-[20px] border border-white/10 object-cover bg-[#0b0e14] sm:h-[104px] sm:w-[104px]" />
                    </div>
                  </div>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1.5 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0">
                        ...
                        <div className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-white/12 bg-[linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.04))] px-2.5 py-1 text-[13px] font-medium text-gray-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
                        ...
                        <div className="flex w-full sm:w-auto sm:pt-0.5">
                          {isFollowing ? (
                            <button
                              ...
                              className="inline-flex h-[42px] w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.035))] px-[18px] text-sm font-bold text-gray-100 shadow-[0_10px_24px_rgba(7,12,22,0.22)] transition-colors hover:border-red-400/35 hover:text-white sm:w-auto"
                            >
                ...
                <div className="grid grid-cols-1 gap-2 min-[380px]:grid-cols-3 sm:gap-2.5">
                  {[
                    ...
                    <div
                      key={label}
                      className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.075),rgba(255,255,255,0.028))] px-3 py-2.5 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_8px_18px_rgba(7,10,19,0.16)] backdrop-blur-lg min-[380px]:min-w-0"
                    >
                ...
                {isOwnProfile && (
                  <div className="grid grid-cols-2 gap-2.5">
                    <button
                      ...
                      className="inline-flex h-[42px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.035))] px-4 text-sm font-bold text-white shadow-[0_10px_22px_rgba(7,12,22,0.2)] transition-colors hover:border-brand-purple/40 hover:bg-white/[0.06]"
                    >
            ...
            <div className="grid grid-cols-1 gap-2.5 lg:grid-cols-[minmax(0,1.45fr)_minmax(0,0.9fr)]">
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.075),rgba(255,255,255,0.028))] p-3.5 shadow-[inset_0_1px_0_rgba(64,212,255,0.045),0_16px_34px_rgba(5,10,20,0.2)]">
                <div className="flex items-start justify-between gap-2.5">
                  ...
                  <div className="rounded-xl border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.035))] p-2 text-fuchsia-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                ...
                {canViewTopPulls && topPulls.length > 0 ? (
                  <div className="-mx-1 mt-3 flex gap-2.5 overflow-x-auto px-1 pb-1 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                    {topPulls.slice(0, 4).map((item, index) => (
                      <div
                        key={item.instanceId}
                        className="min-w-[110px] flex-1 rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-2.5 shadow-[0_12px_26px_rgba(4,8,17,0.34)]"
                      >
                  ...
                  <div className="mt-3 rounded-2xl border border-dashed border-white/10 bg-black/15 px-4 py-4 text-sm text-gray-400">
                    {canViewTopPulls ? 'Your best pulls will show here once you open more boxes.' : 'This player keeps their best pulls private.'}
                  </div>
                )}
              </div>

              <div className="grid grid-cols-1 gap-2 rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.075),rgba(255,255,255,0.028))] p-3.5 shadow-[inset_0_1px_0_rgba(64,212,255,0.045),0_16px_34px_rgba(5,10,20,0.2)] min-[420px]:grid-cols-3 lg:grid-cols-1">
                {[
                  ...
                  <div key={label} className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] px-3 py-2.5">
            ...
            <div className="relative w-full max-w-full">
              <div
                ref={tabScrollRef}
                className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.035] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] w-full max-w-full overflow-x-auto whitespace-nowrap scroll-smooth snap-x snap-mandatory [&::-webkit-scrollbar]:hidden"
