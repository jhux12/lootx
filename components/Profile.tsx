...
export const Profile: React.FC = () => {
  const { user, inventory, shipments, boxes, sellItem, shipItem, stripeSettings, openAuthModal, setView, updateAddress, updateUserInfo, setShowEmailVerificationModal } = useGame();
