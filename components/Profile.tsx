...
export const Profile: React.FC = () => {
  ...
  const isFollower = !!(!isOwnProfile && profileUser && Array.isArray(profileUser.followers) && profileUser.followers.includes(user.id));
  ...
  const handleFollowClick = async () => {
      if (!profileUser || isFollower) return;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
                <div className="bg-[#131720] border border-gray-800 rounded-2xl p-6">
                    ...
                    <p className="text-gray-400 text-sm">Public view of this player. Follow them to keep up with their drops and battles.</p>
                ...
                <div className="space-y-6">
                     ...
                     <div className="bg-[#131720] border border-gray-800 rounded-xl p-6">
                        ...
                        {viewedFollowers.length ? (
                            ...
                            <div className="text-center py-6 text-gray-500 bg-[#0b0e14] rounded-lg border border-dashed border-gray-800">
                                You have no followers yet. Share your profile to get followed.
                            </div>
                        )}
                     </div>
