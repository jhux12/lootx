                  ...
                  <div className={`live-wins-ticker flex w-max items-center gap-2 px-2 py-1.5 sm:gap-2.5 ${startTickerAnimation ? 'ticker-animation [animation-duration:65s]' : ''}`}>
                    {[...catalogLivePullz, ...catalogLivePullz].map((win, index) => (
                      <button
                        ...
                        className={`group flex h-[84px] w-[108px] shrink-0 items-center justify-center overflow-hidden rounded-sm p-1.5 transition hover:-translate-y-0.5 active:scale-[0.99] sm:h-[92px] sm:w-[116px] ${CATALOG_TICKER_RARITY_CARD_CLASS[win.rarity]}`}
                        title={win.itemName}
                      >
