  ...
  return (
    <section className="group relative w-full overflow-hidden rounded-[28px] border border-white/10 bg-[#060910] px-5 py-7 sm:px-8 sm:py-10 lg:px-14 lg:py-14">
      <div className="pointer-events-none absolute inset-0 rounded-[28px]">
        ...
        <div className="absolute -right-24 top-[-10%] h-[460px] w-[460px] rounded-full bg-fuchsia-500/22 blur-[120px]" />
        <div className="absolute right-[14%] top-[20%] h-[380px] w-[380px] rounded-full bg-violet-500/25 blur-[110px]" />
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-5 sm:space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-slate-900/50 px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-100 shadow-[0_0_24px_rgba(94,92,230,0.35)] backdrop-blur-md sm:text-xs">
            <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-br from-blue-500/90 to-fuchsia-500/90 text-white shadow-[0_0_14px_rgba(99,102,241,0.65)]">
          ...
          <div className="space-y-3">
            <h1 className="max-w-2xl text-4xl font-black uppercase tracking-tight text-white sm:text-5xl sm:leading-[0.95] lg:text-7xl lg:leading-[0.92]">
              Fair Value <span className="block bg-gradient-to-r from-indigo-400 via-violet-400 to-fuchsia-400 bg-clip-text text-transparent">Guarantee</span>
            </h1>
          ...
          <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center">
            <button
              ...
              className="inline-flex min-h-12 items-center justify-center rounded-xl bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500 px-7 py-3 text-sm font-bold uppercase tracking-[0.08em] text-white shadow-[0_16px_45px_-20px_rgba(168,85,247,0.9)] transition duration-300 hover:brightness-110 hover:shadow-[0_20px_55px_-24px_rgba(99,102,241,0.95)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300/70"
            >
              Sign Up &amp; Get Free Box
            </button>
            <button
              onClick={() => scrollToSection('how-it-works')}
              className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/20 bg-black/20 px-7 py-3 text-sm font-semibold uppercase tracking-[0.08em] text-slate-100 transition hover:border-violet-300/50 hover:bg-white/10"
            >
              Learn More
            </button>
          </div>
        ...
        <div className="relative flex items-end justify-center pt-4 lg:pt-0">
          ...
          <img
            ...
            height={960}
            style={{
              filter: 'drop-shadow(0 0 24px rgba(99,102,241,0.35)) drop-shadow(0 0 60px rgba(236,72,153,0.2))'
            }}
          />
