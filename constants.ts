...
export const MYSTERY_BOXES: MysteryBox[] = [
  { id: 'supreme', name: 'Case Supreme', price: 50.00, image: 'https://picsum.photos/id/175/300/300', accentColor: '#ef4444', tag: 'Hot', items: CASE_ITEMS, riskBalance: 40 },
  ...
  { id: 'sneaker', name: 'Sneakerhead', price: 95.00, image: 'https://picsum.photos/id/21/300/300', accentColor: '#22c55e', items: CASE_ITEMS, riskBalance: 30 },
  { id: 'watch', name: 'Timekeeper', price: 290.00, image: 'https://picsum.photos/id/180/300/300', accentColor: '#eab308', items: CASE_ITEMS, riskBalance: 75 },
];
