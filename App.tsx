  ...
  return (
    <main className="flex-1 min-w-0 pb-[90px] sm:pb-10 transition-[width] duration-200 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
      ...
      {view.type === 'HOME' && showHomePrompt && !isAuthenticated && (
        <div className="fixed bottom-[calc(var(--pullz-mobile-bottom-nav-height,72px)+0.75rem)] left-1/2 z-[150] w-[calc(100%-1rem)] max-w-md -translate-x-1/2 rounded-2xl border border-slate-500/25 bg-[#101827]/95 p-4 shadow-[0_20px_45px_rgba(0,0,0,0.55)] backdrop-blur-md lg:bottom-4">
...
const AppShell = () => {
  ...
  return (
    <div className="pullz-app-bg min-h-[100dvh] text-white font-sans selection:bg-blue-500 selection:text-white flex flex-col">
      <SeoHead view={view} />
      <Header
