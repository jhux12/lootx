...
const MainContent: React.FC<{ isChatCollapsed: boolean }> = ({ isChatCollapsed }) => {
...
const AppLayout: React.FC = () => {
  ...
  const layoutStyle = {
    '--chatw': isChatCollapsed ? '64px' : '360px'
  ...
  return (
    <div className="min-h-screen bg-[#050811] text-white font-sans selection:bg-blue-500 selection:text-white flex flex-col">
      ...
      <div
        ...
        style={layoutStyle}
      >
        <div className="flex-1 min-w-0 transition-[padding] duration-200 ease-[cubic-bezier(0.2,0.8,0.2,1)] xl:pr-[var(--chatw)]">
          <MainContent isChatCollapsed={isChatCollapsed} />
        </div>
        <ChatSidebar isCollapsed={isChatCollapsed} onToggle={setIsChatCollapsed} />
      </div>
