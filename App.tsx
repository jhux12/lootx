...
const MainContent: React.FC<MainContentProps> = ({ isChatCollapsed }) => {
  ...
  return (
    <main className="flex-1 min-w-0 pb-10 xl:pr-[var(--chatw)] transition-[padding] duration-200 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
      {view.type === 'HOME' && (
...
const AppLayout: React.FC = () => {
  ...
  const chatWidth = isChatCollapsed ? '64px' : '360px';
  ...
  return (
    <div className="min-h-screen bg-[#050811] text-white font-sans selection:bg-blue-500 selection:text-white flex flex-col">
      ...
      <div
        ...
        style={{ ['--chatw' as string]: chatWidth }}
      >
