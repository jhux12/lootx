...
export const GameProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    void (async () => {
      try {
        ...
        return {
          ...
          customBadgeLabel: typeof data.customBadgeLabel === 'string' ? data.customBadgeLabel : '',
  ...
  const createCoinPackage = async (pkg: Omit<CoinPackage, 'id'> & { id?: string }) => {
    ...
    const packageData = sanitizeDeep({
      ...
      customBadgeLabel: typeof rawData.customBadgeLabel === 'string' ? rawData.customBadgeLabel.trim() : '',
  ...
  const updateCoinPackage = async (id: string, updates: Partial<CoinPackage>) => {
    ...
    const packageData = sanitizeDeep({
      ...
      customBadgeLabel: updates.customBadgeLabel !== undefined ? String(updates.customBadgeLabel ?? '').trim() : undefined,
