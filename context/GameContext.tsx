...
export const GameProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    void (async () => {
      try {
        ...
        return {
          ...
          bonusLabel: typeof data.bonusLabel === 'string' ? data.bonusLabel : '',
  ...
  const createCoinPackage = async (pkg: Omit<CoinPackage, 'id'> & { id?: string }) => {
    ...
    const packageData = sanitizeDeep({
      ...
      bonusLabel: typeof rawData.bonusLabel === 'string' ? rawData.bonusLabel.trim() : '',
  ...
  const updateCoinPackage = async (id: string, updates: Partial<CoinPackage>) => {
    ...
    const packageData = sanitizeDeep({
      ...
      bonusLabel: updates.bonusLabel !== undefined ? String(updates.bonusLabel ?? '').trim() : undefined,
