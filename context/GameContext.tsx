...
const buildUserProfile = (firebaseUser: FirebaseUser, data: Record<string, any> = {}) => {
  ...
  return {
    ...
    depositMissionCycleStart: Number(data.depositMissionCycleStart ?? 0),
    depositMissionDepositedCents: Number(data.depositMissionDepositedCents ?? 0),
    depositMissionClaims: data.depositMissionClaims ?? {},
