...
export const FOOTER_PAGE_META: Record<FooterPageKey, { label: string; eyebrow: string }> = {
  about: { label: 'About', eyebrow: 'Ripza Help' },
  faq: { label: 'FAQ', eyebrow: 'Ripza Help' },
  terms: { label: 'Terms', eyebrow: 'Ripza Legal' },
  privacy: { label: 'Privacy', eyebrow: 'Ripza Legal' },
  provablyFair: { label: 'Provably Fair', eyebrow: 'Ripza Fairness' },
  shipping: { label: 'Shipping', eyebrow: 'Ripza Help' },
  refund: { label: 'Refunds', eyebrow: 'Ripza Help' },
  contact: { label: 'Contact', eyebrow: 'Ripza Support' }
};
