            ...
            >
              ...
              <div className="border-t border-white/10 bg-black/20 p-4 sm:p-6">
                <div className="flex flex-col gap-3 sm:flex-row">
                  <button
                    onClick={onRetry}
                    className="h-12 flex-1 rounded-xl border border-white/10 bg-white/5 text-sm font-bold text-white transition hover:bg-white/10 inline-flex items-center justify-center gap-2"
                  >
                    <RotateCcw className="h-4 w-4" /> Try Again
                  </button>
                  <button
                    onClick={onClose}
                    className={`h-12 flex-1 rounded-xl text-sm font-bold text-white transition inline-flex items-center justify-center gap-2 ${isWin ? 'bg-emerald-600 hover:bg-emerald-500' : 'bg-red-600 hover:bg-red-500'}`}
                  >
